...
PM_START_TEXT = """
*Hello {} !*
✟ I'm an anime-theme management bot [⛓️](https://telegra.ph/file/e1432a4d1cd6ecb4542df.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text="About Kurapika", callback_data="emiko_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="🔗 Add Kurapika To Your Group 🔗", url=f"t.me/{bu}?startgroup=new"),
    ],
]
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="✟ I'm *Kurapika*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_Kurapika's licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for Kurapika Robot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, Kurapika now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Kurta Clan", url="t.me/Kurta_Clan"),
                    InlineKeyboardButton(text="Logs", url="https://t.me/Kurta_Logs"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
